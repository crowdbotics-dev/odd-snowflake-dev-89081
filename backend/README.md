...
## Project Structure
    ...
    ├── odd_snowflake_dev_89081  # Django project configurations
...
1. Clone this repo and `cd odd_snowflake_dev_89081`
...
2. Clone this repo and `cd odd_snowflake_dev_89081`
