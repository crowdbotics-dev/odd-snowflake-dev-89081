"""
Django settings for odd_snowflake_dev_89081 project.
...
ROOT_URLCONF = 'odd_snowflake_dev_89081.urls'
...
WSGI_APPLICATION = 'odd_snowflake_dev_89081.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "odd_snowflake_dev_89081 API",
    "DESCRIPTION": "API documentation for odd_snowflake_dev_89081 App",
    "VERSION": "v1",
}
